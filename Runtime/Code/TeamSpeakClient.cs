...
#if UNITY_EDITOR
        uint error = TeamSpeakInterface.ts3client_initClientLib(ref cbs, ref cbs_rare, (int)(LogTypes.LogType_FILE | LogTypes.LogType_CONSOLE), null, Application.dataPath + System.IO.Path.DirectorySeparatorChar + "Varonia Back Office/TeamSpeak" + System.IO.Path.DirectorySeparatorChar);
#else
