...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
#endif
public delegate void onEditPlaybackVoiceDataEvent_type(uint64 serverConnectionHandlerID, anyID clientID, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=3)] short[] samples, int sampleCount, int channels);
#if !UNITY_IOS || UNITY_EDITOR
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
#endif
public delegate void onEditPostProcessVoiceDataEvent_type(uint64 serverConnectionHandlerID, anyID clientID, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=3)] short[] samples, int sampleCount, int channels, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=4)] uint[] channelSpeakerArray, ref uint channelFillMask); //const channelSpeakerArry
#if !UNITY_IOS || UNITY_EDITOR
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
#endif
public delegate void onEditMixedPlaybackVoiceDataEvent_type(uint64 serverConnectionHandlerID, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] short[] samples, int sampleCount, int channels, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=3)]  uint[] channelSpeakerArray, ref uint channelFillMask); //const channelSpeakerArray
#if !UNITY_IOS || UNITY_EDITOR
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
#endif
public delegate void onEditCapturedVoiceDataEvent_type(uint64 serverConnectionHandlerID, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] short[] samples, int sampleCount, int channels, ref int edited);
#if !UNITY_IOS || UNITY_EDITOR
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
#endif
...
public static class TeamSpeakCallbacks {
	...
	#endif
	private static void onEditPlaybackVoiceDataEvent_(uint64 serverConnectionHandlerID, anyID clientID, short[] samples, int sampleCount, int channels){
		try {
			if(onEditPlaybackVoiceDataEvent != null){
				onEditPlaybackVoiceDataEvent(serverConnectionHandlerID, clientID, samples, sampleCount, channels);
			}
		} catch (System.Exception ex) {
			Debug.Log("error: " + ex.StackTrace);
		}
	...
	#endif
	private static void onEditPostProcessVoiceDataEvent_(uint64 serverConnectionHandlerID, anyID clientID, short[] samples, int sampleCount, int channels, uint[] channelSpeakerArray, ref uint channelFillMask){
		try {
			if(onEditPostProcessVoiceDataEvent != null){
				onEditPostProcessVoiceDataEvent(serverConnectionHandlerID, clientID, samples, sampleCount, channels, channelSpeakerArray, ref channelFillMask);
			}
		} catch (System.Exception ex) {
			Debug.Log("error: " + ex.StackTrace);
		}
	...
	#endif
	private static void onEditMixedPlaybackVoiceDataEvent_(uint64 serverConnectionHandlerID, short[] samples, int sampleCount, int channels, uint[] channelSpeakerArray, ref uint channelFillMask){
		try {
			if(onEditMixedPlaybackVoiceDataEvent != null){
				onEditMixedPlaybackVoiceDataEvent(serverConnectionHandlerID, samples, sampleCount, channels, channelSpeakerArray, ref channelFillMask);
			}
		} catch (System.Exception ex) {
			Debug.Log("error: " + ex.StackTrace);
		}
	...
	#endif
	private static void onEditCapturedVoiceDataEvent_(uint64 serverConnectionHandlerID, short[] samples, int sampleCount, int channels, ref int edited){
		try {
			if(onEditCapturedVoiceDataEvent != null){
				onEditCapturedVoiceDataEvent(serverConnectionHandlerID, samples, sampleCount, channels, ref edited);
			}
		} catch (System.Exception ex) {
			Debug.Log("error: " + ex.StackTrace);
		}
