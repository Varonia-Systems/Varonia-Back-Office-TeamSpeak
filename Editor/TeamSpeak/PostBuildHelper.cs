...
public static class PostBuildHelper
{
    ...
    public static void OnPostProcessBuild(BuildTarget target, string path)
    {
        ...
        string TempPath = Path.Combine(Application.dataPath, "..", "Packages", "com.varonia.vboteamspeak");

        File.Copy(path, buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "directsound_win32.dll");
        File.Copy(path, buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "directsound_win64.dll");
        File.Copy(path, buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "windowsaudiosession_win32.dll");
        File.Copy(path, buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "windowsaudiosession_win64.dll");
#elif UNITY_STANDALONE_OSX
